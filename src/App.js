...
const Home = () => {
  ...
  const [userData, setUserData] = useState({ telegram_user_id: '', username: '' });
...
{isModalOpen && (
      ...
      <div className='lvl_info_block'>Invite {userData.next_level_referals_needed} more friend for more gifts</div>
